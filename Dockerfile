...
RUN export DEBIAN_FRONTEND=noninteractive && \
    ...
    add-apt-repository 'deb http://repos.fusiondirectory.org/official-releases/debian/fusiondirectory-114-jessie jessie main' && \
    apt-get update && \
    apt-get install -y php-mdb2 \
        ...
        fusiondirectory-plugin-postfix=${FUSIONDIRECTORY_DEB_PKG_VERSION} \
